...
restoredefaultpath % this clears the path
...
addpath('/Users/kloosterman/Library/CloudStorage/Dropbox/PROJECTS/Teaching/23-24SS/FoPra_pupil') % the read_tobii_txt should be in this path

datapath = '/Users/kloosterman/Library/CloudStorage/Dropbox/PROJECTS/Teaching/23-24SS/FoPra_pupil'; % replace this path with your data path
cd(datapath)
...
data = read_tobii_txt(fullfile(datapath, 'raw', 'G643402_Arousing_Eyecatchers_Session2_2024-06-10_14h47.06.152.txt')); % replace txt with your own data file

% Now you should have a structure called "data" in your workspace

%% save the data to file
mkdir data
save data/Proband1.mat data  % this saves variable "data" into file Proband1.mat 
